...
<html>
	<head>
		<title>Stock Available - GeekPhones</title>
	...
	<body>
		...
		<div class="container">
			...
			<br />
			<br />
			<h3 align="center">Right now we have on stock only 3 Models of phone</h3><br />
			<br /><br />
			<?php
...
<body>
    ...
    <form class="paypal" action="http://localhost/PI18_19_Gr26-master/paypal-example-master/" method="post" id="paypal_form">
