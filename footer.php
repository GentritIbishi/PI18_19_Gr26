                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3 item">
                                ...
                                <ul id="footer-ul">
                                    <li id="footer-li"><a id="footer-a" href="#">Company</a></li><br>
                                    <li id="footer-li"><a id="footer-a"href="about-us.php">Team</a></li><br>
                                    <li id="footer-li"><a id="footer-a" href="#">Careers</a></li><br>
                                </ul>
                            </div>
                            <div class="col-md-6 item text">
                                <h3 id="h3-time">GeekPhone</h3>
